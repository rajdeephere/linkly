...
|-------|-------|------------------|--------------|--------|
| [00](./00-correct-safe-shortener.md) | Correct, safe shortener on one service | non-enumerable codes, edit reflected instantly, bad URLs rejected | 1–5 | 🔨 in progress (Days 1–4 ✅) |
